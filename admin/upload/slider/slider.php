    ...
    <div class="container">
        <div class="row">
            ...
            <div class="card bg-light mb-3" style="max-width: 100%;">
                        <div class="card-header"><b>Upload Slider</b></div>
                            <div class="card-body">
                                <form>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Skill Title</label>
                                    ...
                                    <div class="form-group mt-3">
                                        <label for="exampleInputPassword1">Skill Image</label>
            ...
            <div class="row mt-5">
                    <div class="col-lg-12">
                        <div class="card bg-light mb-4" style="max-width: 100%;">
                                <div class="card-header"><b>Slider Info <a href="" class='btn btn-sm btn-warning'>Eidt</a></b></div>
                                    <div class="card-body">
                                        <table class="table">
                                            <thead>
                                                <tr>
