        ...
        <div class="row">
            ...
            <div class="product_card">
                    <div class="card bg-light mb-3" style="max-width: 100%;">
                        <div class="card-header"><b>Upload Product</b></div>
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="form-group mt-3">
                                        <label for="exampleInputPassword1">Product Discrioption</label>
                                        <input type="text" class="form-control"  placeholder="discription">
                                    </div>
                                    <div class="form-group mt-3">
                                        <label for="exampleInputPassword1">Card Image</label>
            ...
            <div class="row mt-5">
                    <div class="col-lg-12">
                        <div class="card bg-light mb-4" style="max-width: 100%;">
                                <div class="card-header"><b>Product Info <a href="" class='btn btn-sm btn-warning'>Eidt</a></b></div>
                                    <div class="card-body">
                                        <table class="table">
                                            <thead>
                                                <tr>
